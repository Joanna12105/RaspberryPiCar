...
##############################################################################
.. py:module::      : Rieger_TFLite_detection_webcam 
...
**********************************************************************
    ...
    * Filename      : Rieger_TFLite_detection_webcam.py
...
class VideoStream:
    """
    Handles the streaming of the video from the webcam in a separate processing 
    thread.
...
while True:
    ...
    #----------------------------------------------------------------------
    cv2.putText(frame,'FPS: {0:.2f}'.format(frame_rate_calc),(30,50),cv2.FONT_HERSHEY_SIMPLEX,1,(255,127,36),2,cv2.LINE_AA)
